...
typedef struct 
{
    unsigned short Ver1; // 3 大版本号
    unsigned short Ver2;// 4 小版本
    unsigned short Ver3;  //5 小版本的子版本号
}VerData_str;
...
#define bManualCheckSwitch_ST   	M101
#define bManualCheckSwitch	   	    M102

#define bAutoCheckSwitch_ST   	    M103
#define bAutoCheckSwitch	   	    M104
