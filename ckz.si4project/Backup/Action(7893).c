...
void ReadRobotCurrent(void) 
{
	...
	CurAxisDistance->XDistance = tXAxisStepper.cRealPosi;//PluseToPosition(X_AXIS,tXAxisStepper.cRealPosi);// /100)*datatmp / 100;
	CurAxisDistance->YDistance = ulEncoderCount / 2;//cScanDrillRunStep;//ulEncoderCount / 2;
	if(SystemMode > 0)
	{
