...
unsigned char CheckHoleInfo(void)
{
    ...
    unsigned long _lHoleData[4] = {0,0,0,0};
        ...
        for(i = 1;i < HoleNumber;i++)
        {
            ...
            if(_lHoleData[2] >= TempDist.MinHoleR && _lHoleData[2] <= TempDist.MaxHoleR)
            {
            	...
            	if(_lHoleData[3] < TempDist.XBuChangRange)
            	{
					...
					_lHoleData[3] = _lHoleData[3] * TempDist.XBuChangTotal;
            ...
            _lHoleData = _lHoleData / XEncodeDivide;
            if(_lHoleData >= TempDist.MinHoleR && _lHoleData <= TempDist.MaxHoleR)
            {
                Winfos[WorkHoleNumber].hole_point = HoleinfoB[i].hole_point / XEncodeDivide;
                infos[WorkHoleNumber].hole_point = HoleinfoF[i - 1].hole_point / XEncodeDivide;
                WorkHoleNumber++;
            }
            #endif
        }
