...
#define		CS0_RRCV (0)		// 读恢复周期设�? 0-15周期
#define		CS1_RRCV (0)		// 读恢复周期设�? 0-15周期
#define		CS2_RRCV (2)		// 读恢复周期设�? 0-15周期
#define		CS3_RRCV (0)		// 读恢复周期设�? 0-15周期
#define		CS4_RRCV (0)		// 读恢复周期设�? 0-15周期
#define		CS5_RRCV (0)		// 读恢复周期设�? 0-15周期
#define		CS6_RRCV (0)		// 读恢复周期设�? 0-15周期
#define		CS7_RRCV (0)		// 读恢复周期设�? 0-15周期
#define		CS0_WRCV (0)		// 写恢复周期设�? 0-15周期
#define		CS1_WRCV (0)		// 写恢复周期设�? 0-15周期
#define		CS2_WRCV (2)		// 写恢复周期设�? 0-15周期
#define		CS3_WRCV (0)		// 写恢复周期设�? 0-15周期
#define		CS4_WRCV (0)		// 写恢复周期设�? 0-15周期
#define		CS5_WRCV (0)		// 写恢复周期设�? 0-15周期
#define		CS6_WRCV (0)		// 写恢复周期设�? 0-15周期
#define		CS7_WRCV (0)		// 写恢复周期设�? 0-15周期

#define		CS0_CSPWWAIT (0)	// 设置写页面等待周�? 0-7
#define		CS1_CSPWWAIT (0)	// 设置写页面等待周�? 0-7
#define		CS2_CSPWWAIT (0)	// 设置写页面等待周�? 0-7
#define		CS3_CSPWWAIT (0)	// 设置写页面等待周�? 0-7
#define		CS4_CSPWWAIT (0)	// 设置写页面等待周�? 0-7
#define		CS5_CSPWWAIT (0)	// 设置写页面等待周�? 0-7
#define		CS6_CSPWWAIT (0)	// 设置写页面等待周�? 0-7
#define		CS7_CSPWWAIT (0)	// 设置写页面等待周�? 0-7

#define		CS0_CSPRWAIT (0)	// 设置读页面等待周�? 0-7
#define		CS1_CSPRWAIT (0)	// 设置读页面等待周�? 0-7
#define		CS2_CSPRWAIT (0)	// 设置读页面等待周�? 0-7
#define		CS3_CSPRWAIT (0)	// 设置读页面等待周�? 0-7
#define		CS4_CSPRWAIT (0)	// 设置读页面等待周�? 0-7
#define		CS5_CSPRWAIT (0)	// 设置读页面等待周�? 0-7
#define		CS6_CSPRWAIT (0)	// 设置读页面等待周�? 0-7
#define		CS7_CSPRWAIT (0)	// 设置读页面等待周�? 0-7

#define		CS0_CSWWAIT (3)		// 设置正常写等待周�? 0-31
#define		CS1_CSWWAIT (3)		// 设置正常写等待周�? 0-31
#define		CS2_CSWWAIT (5)		// 设置正常写等待周�? 0-31
#define		CS3_CSWWAIT (5)		// 设置正常写等待周�? 0-31
#define		CS4_CSWWAIT (5)		// 设置正常写等待周�? 0-31
#define		CS5_CSWWAIT (3)		// 设置正常写等待周�? 0-31
#define		CS6_CSWWAIT (3)		// 设置正常写等待周�? 0-31
#define		CS7_CSWWAIT (3)		// 设置正常写等待周�? 0-31

#define		CS0_CSRWAIT (3)		// 设置正常读等待周�? 0-31
#define		CS1_CSRWAIT (3)		// 设置正常读等待周�? 0-31
#define		CS2_CSRWAIT (5)		// 设置正常读等待周�? 0-31
#define		CS3_CSRWAIT (5)		// 设置正常读等待周�? 0-31
#define		CS4_CSRWAIT (5)		// 设置正常读等待周�? 0-31
#define		CS5_CSRWAIT (3)		// 设置正常读等待周�? 0-31
#define		CS6_CSRWAIT (3)		// 设置正常读等待周�? 0-31
#define		CS7_CSRWAIT (3)		// 设置正常读等待周�? 0-31
...
#define BOARD_12007         1
//#define BOARD_14007         1
#define		OUTEN			PORT6.DR.BIT.B1
// Timer.c
